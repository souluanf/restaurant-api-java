...
public interface ProductController {
    ...
    @PostMapping(value = PRODUCTS_V1, consumes = APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = PRODUCTS_BY_ID_V1)
    ...
    @GetMapping(value = PRODUCTS_BY_CATEGORY_V1)
    ResponseEntity<List<ProductResponse>> getByCategory(@PathVariable ProductCategory category);
    ...
    @PutMapping(value = PRODUCTS_BY_ID_V1, consumes = APPLICATION_JSON_VALUE)
    ResponseEntity<Object> update(@PathVariable Long id, @Valid @RequestBody ProductRequest request);
}
